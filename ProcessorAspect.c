...
# 769 "ProcessorAspect.c"
{



# 774 "ProcessorAspect.c"
{
...
#line 50 "Processor.c"
interruptVectorTable[CLOCK_BIT] = interruptVectorInitialAddress + 4; 
...
case 'a': registers[0] = registers[registerIR_CPU.operand1] + registers[registerIR_CPU.operand2]; 
...
case 's': registers[registerIR_CPU.operand1] = registerIR_CPU.operand2; 
#line 114 "Processor.c"
registerPC_CPU++; 
#line 115 "Processor.c"
break; 
#line 118 "Processor.c"
case 'd': if (registers[registerIR_CPU.operand2] == 0){
Processor_RaiseInterrupt(EXCEPTION_BIT); }else{
{ 
#line 122 "Processor.c"
registers[0] = registers[registerIR_CPU.operand1] / registers[registerIR_CPU.operand2]; 
...
registers[1] = registerIR_CPU.operand1; 
...
case 'w': registerMBR_CPU.operationCode = registerMBR_CPU.operand1 = registerMBR_CPU.operand2 = registers[registerIR_CPU.operand2]; 
...
case 'i': tempAcc = registers[registerIR_CPU.operand1]; 
...
case 'm': registers[registerIR_CPU.operand2] = registers[registerIR_CPU.operand1]; 
...
ComputerSystem_DebugMessage(3, 'h', registerPC_CPU, registers[0], registerPSW_CPU, Processor_ShowPSW()); 
...
#line 287 "Processor.c"
int registerAccumulator_CPU = registers[0];
